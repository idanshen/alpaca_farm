...
path_to_data = "/data/pulkitag/models/idanshen/alpaca_farm/sft/test_5/output_summary.json"
if os.path.isfile(path_to_data):
    list_dict_data = jload(path_to_data)
else:
    list_dict_data = run_decode(dataset_path="argilla/news-summary",
                                dataset_name="comparisons",
                                split="test",
                                decoder_name_or_path="huggyllama/llama-7b",
                                checkpoint_dir="/data/pulkitag/models/idanshen/alpaca_farm/sft/test_5/adapter_model/",
